...
public class CubemanController : MonoBehaviour
{
    ...
    static public int nowDetectWord = 0;
    Image[] words = new Image[10];
    ...
    void detectWords()
    {
        ...
        switch (nowDetectWord)
        {
            case 0:
                ...
                break;
            case 1:
                isDetected = isKingWord();
                Debug.Log("王" + isDetected);
                break;
            case 2:
                isDetected = isSkyWord();
                Debug.Log("天" + isDetected);
                break;
            case 3:
                isDetected = isWoodWord();
                Debug.Log("木" + isDetected);
                break;
            case 4:
                isDetected = isFireWord();
                Debug.Log("火" + isDetected);
                break;
            case 5:
                isDetected = isMiWord();
                Debug.Log("米" + isDetected);
                break;
            case 6:
                isDetected = isHandWord();
                isDetected = true;
                Debug.Log("手" + isDetected);
                break;
            case 7:
                isDetected = isRonWord();
                Debug.Log("萬"+ isDetected);
                break;
            case 8:
                isDetected = isCardWord();
                Debug.Log("卡"+ isDetected);
                break;
            case 9:
                Debug.Log("end");
                isDetected = false;
        ...
        if (isDetected)
        {
            words[nowDetectWord].transform.localScale = new Vector2(0f, 0f);
            nowDetectWord++;
            words[nowDetectWord].transform.localScale = new Vector2(3f, 3f);
        }
    ...
    void Start()
    {
        ...
        words[0] = GameObject.Find("start").GetComponent<Image>();
        words[1] = GameObject.Find("king").GetComponent<Image>();
        words[2] = GameObject.Find("sky").GetComponent<Image>();
        words[3] = GameObject.Find("wood").GetComponent<Image>();
        words[4] = GameObject.Find("fire").GetComponent<Image>();
        words[5] = GameObject.Find("mi").GetComponent<Image>();
        words[6] = GameObject.Find("hand").GetComponent<Image>();
        words[7] = GameObject.Find("ron").GetComponent<Image>();
        words[8] = GameObject.Find("card").GetComponent<Image>();
        words[9] = GameObject.Find("end").GetComponent<Image>();

        for (int i = 1; i < 9; i++)
        {
            words[i].transform.localScale = new Vector2(0f, 0f);
        }
